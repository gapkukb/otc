...
class Font {
  /// fontSize: 12
  static const mini = TextStyle(fontSize: 12);
  ...
  static const smallGrey = TextStyle(fontSize: 14, color: Colors.grey);

  /// fontSize: 16,color: Colors.grey
  static const mediumGrey = TextStyle(fontSize: 16, color: Colors.grey);

  /// fontSize: 18,color: Colors.grey
  static const largeGrey = TextStyle(fontSize: 18, color: Colors.grey);
