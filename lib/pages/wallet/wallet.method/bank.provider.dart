...
final bankProvider = FutureProvider.autoDispose<List<WalletBankModel>>((ref) async {
  final value = await apis.wallet.getAllBankCards();

  return value.map((e) => WalletBankModel.fromJson(e)).toList();
});

final qrcodeProvider = FutureProvider.autoDispose.family<List<WalletQrcodeModel>, AddType>((ref, addType) async {
