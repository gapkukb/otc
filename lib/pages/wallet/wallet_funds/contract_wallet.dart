...
class ContractWallet extends StatefulWidget {
  const ContractWallet({super.key});

  @override
  State<ContractWallet> createState() => _ContractWalletState();
}

class _ContractWalletState extends State<ContractWallet>
